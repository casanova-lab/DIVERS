...
for eachsample in file_sample:
    ...
    try:
        ...
        if first_read:
            ...
            file_out.write('SAMPLE,CHR,POS,ID,REF,ALT,STRAND,VAR_TYPE,GENE,TRANSCRIPT,IVS#,IVS_SIZE,'
        ...
        for eachline in file_map:
            ...
            if DIVERS_flag:
                var_output_annot += 1
                file_out.write(sample+','+chrom+','+var_pos+','+var_id+','+var_ref+','+var_alt+','+strand+','+var_type+','+
