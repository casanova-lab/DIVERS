...
parser = argparse.ArgumentParser(description="DIVERS - single input")
...
try:
    ...
    file_out.write('CHR,POS,ID,REF,ALT,STRAND,VAR_TYPE,GENE,TRANSCRIPT,IVS#,RS#,RS_CONSEQ,'
    ...
    for eachline in file_map_RS:
        ...
        if DIVERS_flag:
            var_output_annot += 1
            file_out.write(chrom+','+var_pos+','+var_id+','+ref+','+alt+','+strand+','+var_type+','+
